...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { description: @office.description, lat: @office.lat, lon: @office.lon } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { description: @office.description, lat: @office.lat, lon: @office.lon } }
