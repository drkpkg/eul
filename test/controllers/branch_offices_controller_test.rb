...
class BranchOfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch_office" do
    assert_difference('BranchOffice.count') do
      post branch_offices_url, params: { branch_office: { address: @branch_office.address, description: @branch_office.description, latitude: @branch_office.latitude, longitude: @branch_office.longitude, title: @branch_office.title } }
    end
  ...
  test "should update branch_office" do
    patch branch_office_url(@branch_office), params: { branch_office: { address: @branch_office.address, description: @branch_office.description, latitude: @branch_office.latitude, longitude: @branch_office.longitude, title: @branch_office.title } }
